		...
		<ul class="tabs wc-tabs">
			<?php foreach ( $tabs as $key => $tab ) : ?>
				<li class="<?php echo esc_attr( $key ); ?>_tab">
					<a href="#tab-<?php echo esc_attr( $key ); ?>" class="line-hover"><?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', wp_kses( $tab['title'], array( 'span' => array( 'class' => array() ) ) ), $key ); ?></a>
				</li>
			<?php endforeach; ?>
		</ul>
		<?php foreach ( $tabs as $key => $tab ) : ?>
